    ...
    public class ImageFormats
    {
        ...
        public class ImageEngineFormatDetails
        {
            ...
            static Dictionary<ImageEngineFormat, FormatInfo> FormatInfos = new Dictionary<ImageEngineFormat, FormatInfo>
            {
                ...
                { ImageEngineFormat.DDS_ATI1    , new FormatInfo { Name = ImageEngineFormat.DDS_ATI1    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 8 , IsBlockCompressed = true, IsDDS = true, IsPremultiplied = false , ComponentSize = 1, MaxNumChannels = 1, SupportsAlpha = false, SupportsDX10 = true, RequiresDX10 = false } },
