...
//        {
//            LDRColour temp = InterpolateRGBA(lDRColour1, lDRColour2, wc, wcPrec, waPrec);
//            return temp;
//        }
...
//                    palette[i].Colours += InterpolateA(a, b, i, alphaIndexPrecision).Colours;
//            }
//        }
...
//                    EndPoints[p].A = new LDRColour(MinMax[0].r, MinMax[0].g, MinMax[0].b, minA);
//                    EndPoints[p].B = new LDRColour(MinMax[1].r, MinMax[1].g, MinMax[1].b, maxA);
//                }
//            }
...
//                    for(int i = 0; i < alphaNumIndicies; i++)
//                        palette[p][i].Colours += InterpolateA(EndPoints[p].A, EndPoints[p].B, i, alphaPrecision).Colours;
//                }
//            }
