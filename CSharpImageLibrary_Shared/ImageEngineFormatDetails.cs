    ...
    public class ImageFormats
    {
        ...
        public class ImageEngineFormatDetails
        {
            struct FormatInfo
            {
                ...
                public bool SupportsDX10;
                public bool RequiresDX10;
            }

            static Dictionary<ImageEngineFormat, FormatInfo> FormatInfos = new Dictionary<ImageEngineFormat, FormatInfo>
            {
                { ImageEngineFormat.Unknown, new FormatInfo { Name = ImageEngineFormat.Unknown, Type = AbstractHeader.HeaderType.UNKNOWN, BlockSize = -1, Extensions = new List<SupportedExtensions> { SupportedExtensions.UNKNOWN }                      , BitCount = -1, IsBlockCompressed = false, IsDDS = false, IsPremultiplied = false, ComponentSize = -1, MaxNumChannels = -1, SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.PNG    , new FormatInfo { Name = ImageEngineFormat.PNG    , Type = AbstractHeader.HeaderType.PNG    , BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.PNG }                          , BitCount = 32, IsBlockCompressed = false, IsDDS = false, IsPremultiplied = false, ComponentSize = 1 , MaxNumChannels = 4 , SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.JPG    , new FormatInfo { Name = ImageEngineFormat.JPG    , Type = AbstractHeader.HeaderType.JPG    , BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.JPG, SupportedExtensions.JPEG }, BitCount = 24, IsBlockCompressed = false, IsDDS = false, IsPremultiplied = false, ComponentSize = 1 , MaxNumChannels = 3 , SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.BMP    , new FormatInfo { Name = ImageEngineFormat.BMP    , Type = AbstractHeader.HeaderType.BMP    , BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.BMP }                          , BitCount = 32, IsBlockCompressed = false, IsDDS = false, IsPremultiplied = false, ComponentSize = 1 , MaxNumChannels = 4 , SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.TGA    , new FormatInfo { Name = ImageEngineFormat.TGA    , Type = AbstractHeader.HeaderType.TGA    , BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.TGA }                          , BitCount = 32, IsBlockCompressed = false, IsDDS = false, IsPremultiplied = false, ComponentSize = 1 , MaxNumChannels = 4 , SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.GIF    , new FormatInfo { Name = ImageEngineFormat.GIF    , Type = AbstractHeader.HeaderType.GIF    , BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.GIF }                          , BitCount = 32, IsBlockCompressed = false, IsDDS = false, IsPremultiplied = false, ComponentSize = 1 , MaxNumChannels = 4 , SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.TIF    , new FormatInfo { Name = ImageEngineFormat.TIF    , Type = AbstractHeader.HeaderType.TIFF   , BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.TIF }                          , BitCount = 32, IsBlockCompressed = false, IsDDS = false, IsPremultiplied = false, ComponentSize = 1 , MaxNumChannels = 4 , SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },

                { ImageEngineFormat.DDS_DXT1    , new FormatInfo { Name = ImageEngineFormat.DDS_DXT1    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 8 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32, IsBlockCompressed = true, IsDDS = true, IsPremultiplied = false , ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = true, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_DXT2    , new FormatInfo { Name = ImageEngineFormat.DDS_DXT2    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32, IsBlockCompressed = true, IsDDS = true, IsPremultiplied = true  , ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = true, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_DXT3    , new FormatInfo { Name = ImageEngineFormat.DDS_DXT3    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32, IsBlockCompressed = true, IsDDS = true, IsPremultiplied = false , ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = true, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_DXT4    , new FormatInfo { Name = ImageEngineFormat.DDS_DXT4    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32, IsBlockCompressed = true, IsDDS = true, IsPremultiplied = true  , ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = true, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_DXT5    , new FormatInfo { Name = ImageEngineFormat.DDS_DXT5    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32, IsBlockCompressed = true, IsDDS = true, IsPremultiplied = false , ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = true, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_ATI1    , new FormatInfo { Name = ImageEngineFormat.DDS_ATI1    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 8 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 8 , IsBlockCompressed = true, IsDDS = true, IsPremultiplied = false , ComponentSize = 1, MaxNumChannels = 1, SupportsAlpha = false, SupportsDX10 = true, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_ATI2_3Dc, new FormatInfo { Name = ImageEngineFormat.DDS_ATI2_3Dc, Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 16, IsBlockCompressed = true, IsDDS = true, IsPremultiplied = false , ComponentSize = 1, MaxNumChannels = 2, SupportsAlpha = false, SupportsDX10 = true, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_BC6     , new FormatInfo { Name = ImageEngineFormat.DDS_BC6     , Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32, IsBlockCompressed = true, IsDDS = true, IsPremultiplied = false , ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = true, RequiresDX10 = true  } },
                { ImageEngineFormat.DDS_BC7     , new FormatInfo { Name = ImageEngineFormat.DDS_BC7     , Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32, IsBlockCompressed = true, IsDDS = true, IsPremultiplied = false , ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = true, RequiresDX10 = true  } },

                { ImageEngineFormat.DDS_RGB_8   , new FormatInfo { Name = ImageEngineFormat.DDS_RGB_8   , Type = AbstractHeader.HeaderType.DDS, BlockSize = 3 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 24 , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 3, SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_ARGB_8  , new FormatInfo { Name = ImageEngineFormat.DDS_ARGB_8  , Type = AbstractHeader.HeaderType.DDS, BlockSize = 4 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32 , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_ARGB_4  , new FormatInfo { Name = ImageEngineFormat.DDS_ARGB_4  , Type = AbstractHeader.HeaderType.DDS, BlockSize = 2 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 16 , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_ABGR_8  , new FormatInfo { Name = ImageEngineFormat.DDS_ABGR_8  , Type = AbstractHeader.HeaderType.DDS, BlockSize = 4 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32 , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_V8U8    , new FormatInfo { Name = ImageEngineFormat.DDS_V8U8    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 2 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 16 , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 2, SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_G8_L8   , new FormatInfo { Name = ImageEngineFormat.DDS_G8_L8   , Type = AbstractHeader.HeaderType.DDS, BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 8  , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 1, SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_A8L8    , new FormatInfo { Name = ImageEngineFormat.DDS_A8L8    , Type = AbstractHeader.HeaderType.DDS, BlockSize = 2 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 16 , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 2, SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_R5G6B5  , new FormatInfo { Name = ImageEngineFormat.DDS_R5G6B5  , Type = AbstractHeader.HeaderType.DDS, BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 16 , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 3, SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_A8      , new FormatInfo { Name = ImageEngineFormat.DDS_A8      , Type = AbstractHeader.HeaderType.DDS, BlockSize = 1 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 8  , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 1, SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_G16_R16 , new FormatInfo { Name = ImageEngineFormat.DDS_G16_R16 , Type = AbstractHeader.HeaderType.DDS, BlockSize = 4 , Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 32 , IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 2, SupportsAlpha = false, SupportsDX10 = false, RequiresDX10 = false } },
                { ImageEngineFormat.DDS_ARGB_32F, new FormatInfo { Name = ImageEngineFormat.DDS_ARGB_32F, Type = AbstractHeader.HeaderType.DDS, BlockSize = 16, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = 128, IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true , SupportsDX10 = false, RequiresDX10 = false } },

                { ImageEngineFormat.DX10_Placeholder, new FormatInfo { Name = ImageEngineFormat.DX10_Placeholder, Type = AbstractHeader.HeaderType.DDS, BlockSize = -1, Extensions = new List<SupportedExtensions> { SupportedExtensions.DDS }, BitCount = -1, IsBlockCompressed = false, IsDDS = true, IsPremultiplied = false, ComponentSize = 1, MaxNumChannels = 4, SupportsAlpha = true, SupportsDX10 = true, RequiresDX10 = true } },
            ...
            /// <summary>
            /// Indicates format is supported in DX10 BY THIS TOOL. Limited to BC formats for now.
            /// </summary>
            public bool SupportsDX10 => Format.SupportsDX10;

            /// <summary>
            /// Indicates whether format is only supported as DX10. e.g. BC6 and BC7.
            /// </summary>
            public bool RequiresDX10 => Format.RequiresDX10;

            /// <summary>
            /// Human readable format of image.
            /// </summary>
            public ImageEngineFormat SurfaceFormat => Format.Name;
            ...
            /// </summary>
            public bool ValidSaveFormat => 
                SurfaceFormat != ImageEngineFormat.TGA 
                && SurfaceFormat != ImageEngineFormat.Unknown 
                && SurfaceFormat != ImageEngineFormat.DX10_Placeholder;
            ...
            /// <summary>
            /// Indicates whether format supports alpha.
            /// </summary>
            public bool SupportsAlpha => Format.SupportsAlpha;


            /// <summary>
            /// Indicates whether format supports editing alpha (premultiplied is not editable for eg)
            /// </summary>
            public bool SupportsAlphaEditing => Format.SupportsAlpha && !IsPremultipliedFormat && !ValidSaveFormat;
            ...
            FormatInfo DetermineDDSSurfaceFormat(DDS_Header header)
            {
                ...
                validFourCC = validFourCC && ddspf.dwFourCC != FourCC.Unknown;
            ...
            public int GetUncompressedSize(int topWidth, int topHeight, bool inclMips)
            {
            ...
            public override string ToString()
            {
                ...
                foreach (PropertyDescriptor descriptor in TypeDescriptor.GetProperties(this))
                {
                    ...
                    string value = descriptor.GetValue(this).ToString();
