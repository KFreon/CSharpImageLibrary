...
namespace CSharpImageLibrary.DDS
{
    public static class BC6
    {
        ...
        struct ModeInfo
        {
            ...
            public RGBAColour[][] RGBAPrec;  // [BC6 max regions][2]

            public ModeInfo(int modeIndex, int mode, int partitions, bool transformed, int indexPrecision, RGBAColour[] first, RGBAColour[] second)
            {
                ...
                RGBAPrec = new RGBAColour[BC6H_MAX_REGIONS][] { first, second };
            }
        }

        static INTColour SignExtend(INTColour c, RGBAColour prec)
        {
        ...
        internal struct INTColour
        {
            ...
            public INTColour(ScRGBAColour colour, int pad, bool isSigned)
            {
            ...
            internal RGBAColour ToRGBAColour(bool isSigned)
            {
                var r = IntToFloatIsh(R, isSigned);
                var g = IntToFloatIsh(G, isSigned);
                var b = IntToFloatIsh(B, isSigned);

                return UsefulDotNetThings.General.Graphics.ScRGBToARGB(1f, r, g, b);
            }
        ...
        {
            new ModeInfo(0, 0x00, 1, true,  3, new RGBAColour[] { new RGBAColour(10,10,10,0), new RGBAColour( 5, 5, 5,0) },    new RGBAColour[] { new RGBAColour( 5, 5, 5,0), new RGBAColour( 5, 5, 5,0) }),
            new ModeInfo(1, 0x01, 1, true,  3, new RGBAColour[] { new RGBAColour(7,7,7,0),    new RGBAColour( 6, 6, 6,0) },    new RGBAColour[] { new RGBAColour( 6, 6, 6,0), new RGBAColour( 6, 6, 6,0) }),
            new ModeInfo(2, 0x02, 1, true,  3, new RGBAColour[] { new RGBAColour(11,11,11,0), new RGBAColour( 5, 4, 4,0) },    new RGBAColour[] { new RGBAColour( 5, 4, 4,0), new RGBAColour( 5, 4, 4,0) }),
            new ModeInfo(3, 0x06, 1, true,  3, new RGBAColour[] { new RGBAColour(11,11,11,0), new RGBAColour( 4, 5, 4,0) },    new RGBAColour[] { new RGBAColour( 4, 5, 4,0), new RGBAColour( 4, 5, 4,0) }),
            new ModeInfo(4, 0x0a, 1, true,  3, new RGBAColour[] { new RGBAColour(11,11,11,0), new RGBAColour( 4, 4, 5,0) },    new RGBAColour[] { new RGBAColour( 4, 4, 5,0), new RGBAColour( 4, 4, 5,0) }),
            new ModeInfo(5, 0x0e, 1, true,  3, new RGBAColour[] { new RGBAColour(9,9,9,0),    new RGBAColour( 5, 5, 5,0) },    new RGBAColour[] { new RGBAColour( 5, 5, 5,0), new RGBAColour( 5, 5, 5,0) }),
            new ModeInfo(6, 0x12, 1, true,  3, new RGBAColour[] { new RGBAColour(8,8,8,0),    new RGBAColour( 6, 5, 5,0) },    new RGBAColour[] { new RGBAColour( 6, 5, 5,0), new RGBAColour( 6, 5, 5,0) }),
            new ModeInfo(7, 0x16, 1, true,  3, new RGBAColour[] { new RGBAColour(8,8,8,0),    new RGBAColour( 5, 6, 5,0) },    new RGBAColour[] { new RGBAColour( 5, 6, 5,0), new RGBAColour( 5, 6, 5,0) }),
            new ModeInfo(8, 0x1a, 1, true,  3, new RGBAColour[] { new RGBAColour(8,8,8,0),    new RGBAColour( 5, 5, 6,0) },    new RGBAColour[] { new RGBAColour( 5, 5, 6,0), new RGBAColour( 5, 5, 6,0) }),
            new ModeInfo(9, 0x1e, 1, false, 3, new RGBAColour[] { new RGBAColour(6,6,6,0),    new RGBAColour( 6, 6, 6,0) },    new RGBAColour[] { new RGBAColour( 6, 6, 6,0), new RGBAColour( 6, 6, 6,0) }),
            new ModeInfo(10, 0x03, 0, false, 4, new RGBAColour[] { new RGBAColour(10,10,10,0), new RGBAColour( 10, 10, 10,0) }, new RGBAColour[] { new RGBAColour( 0, 0, 0,0), new RGBAColour( 0, 0, 0,0) }),
            new ModeInfo(11, 0x07, 0, true,  4, new RGBAColour[] { new RGBAColour(11,11,11,0), new RGBAColour( 9, 9, 9,0) },    new RGBAColour[] { new RGBAColour( 0, 0, 0,0), new RGBAColour( 0, 0, 0,0) }),
            new ModeInfo(12, 0x0b, 0, true,  4, new RGBAColour[] { new RGBAColour(12,12,12,0), new RGBAColour( 8, 8, 8,0) },    new RGBAColour[] { new RGBAColour( 0, 0, 0,0), new RGBAColour( 0, 0, 0,0) }),
            new ModeInfo(13, 0x0f, 0, true,  4, new RGBAColour[] { new RGBAColour(16,16,16,0), new RGBAColour( 4,4, 4,0) },     new RGBAColour[] { new RGBAColour( 0,0, 0,0),  new RGBAColour( 0,0, 0,0) } )
        };
        #endregion Tables

        #region Decompression
        internal static RGBAColour[] DecompressBC6(byte[] source, int sourceStart, bool isSigned)
        {
            ...
            if (ModeToInfo[mode] >= 0)
            {
                ...
                for (int i = 0; i < NUM_PIXELS_PER_BLOCK; i++)
                {
                    ...
                    RGBAColour colour = fc.ToRGBAColour(isSigned);
                    colour.A = 255;
                    block[i] = colour;
                }
            }
        ...
        private static void TransformInverse(INTColourPair[] endPoints, RGBAColour prec, bool isSigned)
        {
        ...
        internal static void CompressBC6Block(byte[] source, int sourceStart, int sourceLineLength, byte[] destination, int destStart, INTColour[] overrides = null, ScRGBAColour[] overrides2 = null)
        {
            int modeVal = 0;
            ...
            ScRGBAColour[] pixels = new ScRGBAColour[NUM_PIXELS_PER_BLOCK];
            ...
            else
            {
                for (int i = 0; i < 4; i++)
                {
                    for (int j = 0; j < 4; j++)
                    {
                        ...
                        var pixel = UsefulDotNetThings.General.Graphics.ARGBToScRGBA(a, r, g, b);
                        pixels[i * 4 + j] = pixel;
        ...
        static float RoughMSE(ref INTColourPair[] endPoints, ModeInfo mode, int shape, INTColour[] block, ScRGBAColour[] pixels, bool isSigned)
        {
            ...
            for (int p = 0; p <= mode.Partitions; p++)
            {
                ...
                ScRGBAColour[] minMax = OptimiseRGB_BC67(pixels, 4, np, pixelIndicies);
