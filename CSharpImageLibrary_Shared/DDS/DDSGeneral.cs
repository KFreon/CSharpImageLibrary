...
namespace CSharpImageLibrary.DDS
{
    ...
    public static class DDSGeneral
    {
        ...
        internal static int BuildMipMaps(List<MipMapBase> MipMaps)
        {
            if (MipMaps?.Count == 0)
                return 0;

            MipMapBase currentMip = MipMaps[0];
            ...
            MipMapBase[] newmips = new MipMapBase[estimatedMips];
            ...
            Action<int> action = new Action<int>(item =>
            {
                ...
                newmip = currentMip.Resize(scale);
