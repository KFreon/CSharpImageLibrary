...
namespace CSharpImageLibrary.DDS
{
    ...
    {
        internal static byte[] Save(List<MipMapBase> mipMaps, ImageFormats.ImageEngineFormatDetails destFormatDetails, AlphaSettings alphaSetting)
        {
            ...
            if (destFormatDetails.IsBlockCompressed)
            {
                ...
                foreach (MipMapBase mipmap in mipMaps)
                {
        ...
        static int WriteCompressedMipMap(byte[] destination, int mipOffset, MipMapBase mipmap, int blockSize, Action<byte[], int, int, byte[], int, AlphaSettings, ImageFormats.ImageEngineFormatDetails> compressor,
        ...
        static void WriteUncompressedMipMap(byte[] destination, int mipOffset, MipMapBase mipmap, ImageFormats.ImageEngineFormatDetails destFormatDetails, DDS_PIXELFORMAT ddspf)
        {
